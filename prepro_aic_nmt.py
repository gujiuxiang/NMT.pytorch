...
parser.add_argument('-train_src', default='data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/train_0129.zh',
                    help="Path to the training source data")
parser.add_argument('-train_tgt', default='data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/train_0129.en',
                    help="Path to the training target data")
parser.add_argument('-valid_src', default='data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/valid_0129.zh',
                    help="Path to the validation source data")
parser.add_argument('-valid_tgt', default='data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/valid_0129.en',
                    help="Path to the validation target data")

parser.add_argument('-save_data', default='data/ai_challenger/machine_translation/nmt_t2t_data_filtered_0129/nmt_filtered_0129',
...
def filter_sentences():
    ...
    split = 'val'
    if split == 'train':
        src_file = 'data/ai_challenger/machine_translation/ai_challenger_translation_train_20170912/translation_train_20170912/train.zh'
        tgt_file = 'data/ai_challenger/machine_translation/ai_challenger_translation_train_20170912/translation_train_20170912/train.en'
        save_src_file = "data/ai_challenger/machine_translation/ai_challenger_translation_train_20170912/translation_train_20170912/train_filtered_0303.zh"
        save_tgt_file = "data/ai_challenger/machine_translation/ai_challenger_translation_train_20170912/translation_train_20170912/train_filtered_0303.en"
    if split == 'val':
        src_file = 'data/ai_challenger/machine_translation/ai_challenger_translation_validation_20170912/translation_validation_20170912/valid.en-zh.zh'
        tgt_file = 'data/ai_challenger/machine_translation/ai_challenger_translation_validation_20170912/translation_validation_20170912/valid.en-zh.en'
        save_src_file = "data/ai_challenger/machine_translation/ai_challenger_translation_validation_20170912/translation_validation_20170912/valid_0303.en-zh.zh"
        save_tgt_file = "data/ai_challenger/machine_translation/ai_challenger_translation_validation_20170912/translation_validation_20170912/valid_0303.en-zh.en"
